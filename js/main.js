...
function getMovies(searchText){
    ...
    axios.get('https://www.omdbapi.com/?apikey=51b188ed&s='+searchText)
        .then((response) => {
            ...
            $.each(movies, (index, movie) => {
                output += `
                <div id="movieBox" class="col-md-3">
...
function getMovie(){
    ...
    axios.get('https://www.omdbapi.com/?apikey=51b188ed&i='+movieId+'&plot=full')
        .then((response) => {
            console.log(response);
            ...
            <div class="row">
                ...
                <div class="col-md-8" class="">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item"><strong>Writer: ${movie.Wrriter}</strong></li>
                        <li class="list-group-item"><strong>Actors: ${movie.Actors}</strong></li>
                    </ul>
                </div>
            </div>

            <div class="row movie-footer">
                <div class="well">
                    <h3>Plot</h3>
                    ${movie.Plot}
                    <hr>
